...
describe('VideoOptionsService', () => {
  ...
  it('should add fps, speed, rotate, and crop parameters', () => {
    const request = new Request(
      'https://example.com/videos/test.mp4?width=720&height=480&fps=30&speed=1.5&rotate=90&crop=100,100,500,500'
    );
    const params = new URLSearchParams(
      'width=720&height=480&fps=30&speed=1.5&rotate=90&crop=100,100,500,500'
    );
  ...
  it('should normalize and apply filename parameter when valid', () => {
    const request = new Request(
      'https://example.com/videos/test.mp4?filename=Shortened-Clip_5S.MP4'
    );
