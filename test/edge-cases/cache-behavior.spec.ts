...
import { createMockRequest, createMockConfig, mockFetch, setupMockCf } from '../utils/test-utils';
...
describe('Cache Behavior and Edge Cases', () => {
  ...
  describe('Edge cases', () => {
    it('should handle URLs with unusual characters', async () => {
      ...
      const complexUrl =
        'https://example.com/videos/My Video with spaces & 特殊文字.mp4?width=720&height=480';
