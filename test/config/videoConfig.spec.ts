...
describe('Video Configuration', () => {
  ...
  describe('Cache Configuration', () => {
    ...
    it('should define high traffic cache with longer TTL', () => {
      // Assert
      expect(videoConfig.cache.highTraffic).toBeDefined();
      expect(videoConfig.cache.highTraffic.ttl.ok).toBeGreaterThan(videoConfig.cache.default.ttl.ok);
    });
  });
});