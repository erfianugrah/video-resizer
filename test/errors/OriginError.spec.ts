...
describe('OriginError', () => {
  it('should create a basic origin error with proper name and type', () => {
    const error = new OriginError('Test origin error', OriginErrorType.ORIGIN_NOT_FOUND);
  ...
  it('should include context information', () => {
    ...
    const error = new OriginError('Origin not found', OriginErrorType.ORIGIN_NOT_FOUND, context);
  ...
  it('should create source type not supported error correctly', () => {
    ...
    expect(error.message).toBe("Source type 'invalid' is not supported in origin 'videos'");
...
describe('OriginResolutionError', () => {
  it('should create an origin resolution error with proper name and type', () => {
    const path = '/videos/unknown.mp4';
    const error = new OriginResolutionError('No matching origin found', path);
...
describe('SourceResolutionError', () => {
  it('should create a source resolution error with proper name and type', () => {
    const originName = 'videos';
    const sourceType = 'r2';
    const error = new SourceResolutionError('Failed to resolve R2 source', originName, sourceType);
