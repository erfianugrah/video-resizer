// Generated by Wrangler by running `wrangler types` (hash: cc1d57466f2fb1b84b73fa3c2c051178)
...
declare namespace Cloudflare {
	interface Env {
		...
		CACHE_METHOD: "cf";
		CACHE_DEBUG: "true";
		LOGGING_CONFIG: {"pino":{"level":"debug","browser":{"asObject":true},"base":{"service":"video-resizer","env":"development"}},"sampling":{"enabled":false,"rate":1},"breadcrumbs":{"enabled":true,"maxItems":100}} | {"pino":{"level":"debug","browser":{"asObject":true},"base":{"service":"video-resizer","env":"production"}},"sampling":{"enabled":true,"rate":0.1},"breadcrumbs":{"enabled":true,"maxItems":50}} | {"pino":{"level":"debug","browser":{"asObject":true},"base":{"service":"video-resizer","env":"staging"}},"sampling":{"enabled":true,"rate":0.25},"breadcrumbs":{"enabled":true,"maxItems":75}};
		...
		PATH_PATTERNS: [{"name":"videos","matcher":"^/videos/","processPath":true,"baseUrl":null,"originUrl":null,"cacheTtl":3600,"captureGroups":["videoId"],"quality":"high"},{"name":"popular","matcher":"^/popular/(.*\\.mp4)","processPath":true,"baseUrl":null,"originUrl":"https://videos.erfi.dev","cacheTtl":86400,"captureGroups":["videoId"]},{"name":"shorts","matcher":"^/shorts/(.*\\.mp4)","processPath":true,"baseUrl":null,"originUrl":"https://videos.erfi.dev","cacheTtl":43200,"captureGroups":["videoId"],"quality":"medium"},{"name":"standard","matcher":"^/(.*\\.mp4)","processPath":true,"baseUrl":null,"originUrl":"https://videos.erfi.dev","cacheTtl":7200}] | [{"name":"videos","matcher":"^/videos/","processPath":true,"baseUrl":null,"originUrl":null,"cacheTtl":86400,"captureGroups":["videoId"],"quality":"high"},{"name":"popular","matcher":"^/popular/(.*\\.mp4)","processPath":true,"baseUrl":null,"originUrl":"https://videos.erfi.dev","cacheTtl":604800,"captureGroups":["videoId"]},{"name":"shorts","matcher":"^/shorts/(.*\\.mp4)","processPath":true,"baseUrl":null,"originUrl":"https://videos.erfi.dev","cacheTtl":172800,"captureGroups":["videoId"],"quality":"medium"},{"name":"standard","matcher":"^/(.*\\.mp4)","processPath":true,"baseUrl":null,"originUrl":"https://videos.erfi.dev","cacheTtl":86400}];
