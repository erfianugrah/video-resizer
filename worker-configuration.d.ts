// Generated by Wrangler by running `wrangler types` (hash: 1bc363cfd166dbc3ea29eb35af4ce6dc)
// Runtime types generated with workerd@1.20250320.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		CACHE_METHOD: 'cf';
		CACHE_DEBUG: 'true';
		LOGGING_CONFIG: {'pino':{'level':'debug','browser':{'asObject':true},'base':{'service':'video-resizer','env':'development'}},'sampling':{'enabled':false,'rate':1},'breadcrumbs':{'enabled':true,'maxItems':100}} | {'pino':{'level':'debug','browser':{'asObject':true},'base':{'service':'video-resizer','env':'production'}},'sampling':{'enabled':true,'rate':0.05},'breadcrumbs':{'enabled':true,'maxItems':25}} | {'pino':{'level':'debug','browser':{'asObject':true},'base':{'service':'video-resizer','env':'staging'}},'sampling':{'enabled':true,'rate':0.25},'breadcrumbs':{'enabled':true,'maxItems':75}};
		VIDEO_CONFIG: {'derivatives':{'preview':{'width':480,'height':270,'mode':'video','fit':'contain','audio':false,'duration':'3s','quality':'low','compression':'high','preload':'auto'}}} | {'derivatives':{'preview':{'width':480,'height':270,'mode':'video','fit':'contain','audio':false,'duration':'10s','quality':'low','compression':'high','preload':'auto'}}} | {'derivatives':{'preview':{'width':480,'height':270,'mode':'video','fit':'contain','audio':false,'duration':'8s','quality':'low','compression':'high','preload':'auto'}}};
		STORAGE_CONFIG: {'priority':['r2','remote','fallback'],'r2':{'enabled':true,'bucketBinding':'VIDEOS_BUCKET'},'remoteUrl':'https://videos.erfi.dev','remoteAuth':{'enabled':false,'type':'header'},'fallbackUrl':'https://cdn.erfi.dev','fetchOptions':{'userAgent':'Cloudflare-Video-Resizer/1.0'},'pathTransforms':{'videos':{'r2':{'removePrefix':true,'prefix':''},'remote':{'removePrefix':true,'prefix':'videos/'}},'popular':{'r2':{'removePrefix':true,'prefix':'popular/'}},'shorts':{'r2':{'removePrefix':true,'prefix':'shorts/'}}}};
		PATH_PATTERNS: [{'name':'videos','matcher':'^/videos/','processPath':true,'baseUrl':null,'originUrl':null,'ttl':{'ok':3600,'redirects':360,'clientError':60,'serverError':10},'useTtlByStatus':true,'captureGroups':['videoId'],'quality':'high'},{'name':'popular','matcher':'^/popular/(.*\\.mp4)','processPath':true,'baseUrl':null,'originUrl':'https://videos.erfi.dev','ttl':{'ok':86400,'redirects':3600,'clientError':60,'serverError':10},'useTtlByStatus':true,'captureGroups':['videoId']},{'name':'shorts','matcher':'^/shorts/(.*\\.mp4)','processPath':true,'baseUrl':null,'originUrl':'https://videos.erfi.dev','ttl':{'ok':43200,'redirects':3600,'clientError':60,'serverError':10},'useTtlByStatus':true,'captureGroups':['videoId'],'quality':'medium'},{'name':'standard','matcher':'^/(.*\\.mp4)','processPath':true,'baseUrl':null,'originUrl':'https://videos.erfi.dev','ttl':{'ok':7200,'redirects':3600,'clientError':60,'serverError':10},'useTtlByStatus':true}] | [{'name':'videos','matcher':'^/videos/','processPath':true,'baseUrl':null,'originUrl':null,'ttl':{'ok':86400,'redirects':3600,'clientError':60,'serverError':10},'useTtlByStatus':true,'captureGroups':['videoId'],'quality':'high'},{'name':'popular','matcher':'^/popular/(.*\\.mp4)','processPath':true,'baseUrl':null,'originUrl':'https://videos.erfi.dev','ttl':{'ok':604800,'redirects':3600,'clientError':60,'serverError':10},'useTtlByStatus':true,'captureGroups':['videoId']},{'name':'shorts','matcher':'^/shorts/(.*\\.mp4)','processPath':true,'baseUrl':null,'originUrl':'https://videos.erfi.dev','ttl':{'ok':172800,'redirects':3600,'clientError':60,'serverError':10},'useTtlByStatus':true,'captureGroups':['videoId'],'quality':'medium'},{'name':'standard','matcher':'^/(.*\\.mp4)','processPath':true,'baseUrl':null,'originUrl':'https://videos.erfi.dev','ttl':{'ok':86400,'redirects':3600,'clientError':60,'serverError':10},'useTtlByStatus':true}];
